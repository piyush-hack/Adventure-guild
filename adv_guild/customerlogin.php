...
if(isset($_COOKIE['customername']) || isset($_COOKIE['name'])){
...
if(isset($_POST['username']) & isset($_POST['Password'])){
    ...
    $a = mysqli_query($con , "SELECT * FROM requestboard WHERE Username = '$Uname' and Password = '$password'");
    ...
    if(mysqli_num_rows($run) > 0){
        ...
        setcookie("customerno",$result['contactno'], time()+86400);
        setcookie("customerid",$result['id'], time()+86400);

        setcookie("customername",$Uname,time()+86400);
        header('location:front.php');
...
<head>
  ...
  <style>
    ...
    <div id= "myprofile1" class = "myprofile">
                    ...
                    <div class="heading"><p class="intro">LOGIN AS REQUEST PROVIDER<b> Twin star adventure guild</b> to twin star adventure guild</p>
                        <p class="intro">This site provides you the serive of </p>
                        <p class="intro">BE HELPED BY PAYING A LITTLE AMOUNT</p>
                        ...
                        <p class="intro" style="font-size: 5vw;"> <a href="customersignup.php" style="text-decoration: none;">REGISTER</a></p>
                            </div>
